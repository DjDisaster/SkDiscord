...
public class NewEmbed extends Effect {
    static {
        Skript.registerEffect(NewEmbed.class, "[Create] [new] embed with id %string%");
    }
    ...
    protected void execute(Event event) {
        try {
            ...
            Bukkit.getLogger().warning("Error creating embed " + e);
